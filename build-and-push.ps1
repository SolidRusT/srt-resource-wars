...
<#
.SYNOPSIS
    Build and push Resource Wars game server Docker image to Docker Hub

.DESCRIPTION
    Builds the Resource Wars Godot headless server Docker image and optionally pushes to Docker Hub
